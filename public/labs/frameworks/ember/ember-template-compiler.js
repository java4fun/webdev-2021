...
(function () {
  ...
  enifed(
    ...
    [
      ...
      "ember-metal/error",
      "ember-metal/logger",
      "ember-debug/deprecation-manager",
  ...
  */
      _emberMetalCore["default"].deprecate = function (message, test, options) {
        if (_emberMetalCore["default"].ENV.RAISE_ON_DEPRECATION) {
          _emberDebugDeprecationManager["default"].setDefaultLevel(
            _emberDebugDeprecationManager.deprecationLevels.RAISE
          );
        }
        if (
          _emberDebugDeprecationManager["default"].getLevel(
            options && options.id
          ) === _emberDebugDeprecationManager.deprecationLevels.SILENCE
        ) {
          return;
        }
        ...
        if (arguments.length === 3) {
          _emberMetalCore["default"].assert(
            "options argument to Ember.deprecate should be an object",
        ...
        if (
          _emberMetalCore["default"].LOG_STACKTRACE_ON_DEPRECATION &&
          error.stack
        ) {
          var stack;
          var stackStr = "";
  ...
  */
      ...
      function _warnIfUsingStrippedFeatureFlags(
        FEATURES,
        featuresWereStripped
      ) {
        if (featuresWereStripped) {
          _emberMetalCore["default"].warn(
            "Ember.ENV.ENABLE_ALL_FEATURES is only available in canary builds.",
            !_emberMetalCore["default"].ENV.ENABLE_ALL_FEATURES
          );
          _emberMetalCore["default"].warn(
            "Ember.ENV.ENABLE_OPTIONAL_FEATURES is only available in canary builds.",
            !_emberMetalCore["default"].ENV.ENABLE_OPTIONAL_FEATURES
          );
          ...
          for (var key in FEATURES) {
            if (FEATURES.hasOwnProperty(key) && key !== "isEnabled") {
              _emberMetalCore["default"].warn(
                'FEATURE["' +
                  key +
                  '"] is set as enabled, but FEATURE flags are only available in canary builds.',
                !FEATURES[key]
              );
            }
          }
      ...
      if (!_emberMetalCore["default"].testing) {
        ...
        if (
          _emberMetalCore["default"].FEATURES.isEnabled(
            ...
            function () {
              if (
                ...
                _emberMetalCore["default"].debug(
                  "For more advanced debugging, install the Ember Inspector from " +
                    downloadURL
                );
              }
            },
  ...
  */
      ...
      if (runningNonEmberDebugJS) {
        _emberMetalCore["default"].warn(
          "Please use `ember.debug.js` instead of `ember.js` for development and debugging."
        );
      }
    }
  );
  ...
  enifed(
    "ember-debug/deprecation-manager",
    ["exports", "ember-metal/dictionary", "ember-metal/utils"],
    function (exports, _emberMetalDictionary, _emberMetalUtils) {
  ...
  enifed(
    ...
    function (
      ...
      _emberMetalComputed.computed.notEmpty =
        _emberMetalComputed_macros.notEmpty;
      ...
      _emberMetalComputed.computed.readOnly =
        _emberMetalComputed_macros.readOnly;
      _emberMetalComputed.computed.defaultTo =
        _emberMetalComputed_macros.defaultTo;
      _emberMetalComputed.computed.deprecatingAlias =
        _emberMetalComputed_macros.deprecatingAlias;
      ...
      _emberMetalCore["default"].instrument =
        _emberMetalInstrumentation.instrument;
      _emberMetalCore["default"].subscribe =
        _emberMetalInstrumentation.subscribe;
      ...
      _emberMetalCore["default"].platform = {
        ...
        hasPropertyAccessors:
          _emberMetalPlatformDefine_property.hasPropertyAccessors,
      };
      ...
      _emberMetalCore["default"].tryCatchFinally =
        _emberMetalUtils.deprecatedTryCatchFinally;
      ...
      _emberMetalCore["default"].tryFinally =
        _emberMetalUtils.deprecatedTryFinally;
      ...
      _emberMetalCore["default"].getWithDefault =
        _emberMetalProperty_get.getWithDefault;
      _emberMetalCore["default"].normalizeTuple =
        _emberMetalProperty_get.normalizeTuple;
      _emberMetalCore["default"]._getPath = _emberMetalProperty_get._getPath;

      _emberMetalCore["default"].EnumerableUtils =
        _emberMetalEnumerable_utils["default"];

      _emberMetalCore["default"].on = _emberMetalEvents.on;
      _emberMetalCore["default"].addListener = _emberMetalEvents.addListener;
      _emberMetalCore["default"].removeListener =
        _emberMetalEvents.removeListener;
      _emberMetalCore["default"]._suspendListener =
        _emberMetalEvents.suspendListener;
      _emberMetalCore["default"]._suspendListeners =
        _emberMetalEvents.suspendListeners;
      ...
      _emberMetalCore["default"].watchedEvents =
        _emberMetalEvents.watchedEvents;
      _emberMetalCore["default"].listenersFor = _emberMetalEvents.listenersFor;
      _emberMetalCore["default"].accumulateListeners =
        _emberMetalEvents.accumulateListeners;

      _emberMetalCore["default"]._ObserverSet =
        _emberMetalObserver_set["default"];

      _emberMetalCore["default"].propertyWillChange =
        _emberMetalProperty_events.propertyWillChange;
      _emberMetalCore["default"].propertyDidChange =
        _emberMetalProperty_events.propertyDidChange;
      _emberMetalCore["default"].overrideChains =
        _emberMetalProperty_events.overrideChains;
      _emberMetalCore["default"].beginPropertyChanges =
        _emberMetalProperty_events.beginPropertyChanges;
      _emberMetalCore["default"].endPropertyChanges =
        _emberMetalProperty_events.endPropertyChanges;
      _emberMetalCore["default"].changeProperties =
        _emberMetalProperty_events.changeProperties;

      _emberMetalCore["default"].defineProperty =
        _emberMetalProperties.defineProperty;
      ...
      _emberMetalCore["default"].getProperties =
        _emberMetalGet_properties["default"];
      _emberMetalCore["default"].setProperties =
        _emberMetalSet_properties["default"];
      ...
      _emberMetalCore["default"].flushPendingChains =
        _emberMetalChains.flushPendingChains;
      _emberMetalCore["default"].removeChainWatcher =
        _emberMetalChains.removeChainWatcher;
      ...
      _emberMetalCore["default"].unwatchPath =
        _emberMetalWatch_path.unwatchPath;
      ...
      _emberMetalCore["default"].expandProperties =
        _emberMetalExpand_properties["default"];

      _emberMetalCore["default"].ComputedProperty =
        _emberMetalComputed.ComputedProperty;
      ...
      _emberMetalCore["default"].observersFor =
        _emberMetalObserver.observersFor;
      _emberMetalCore["default"].removeObserver =
        _emberMetalObserver.removeObserver;
      _emberMetalCore["default"].addBeforeObserver =
        _emberMetalObserver.addBeforeObserver;
      _emberMetalCore["default"]._suspendBeforeObserver =
        _emberMetalObserver._suspendBeforeObserver;
      _emberMetalCore["default"]._suspendBeforeObservers =
        _emberMetalObserver._suspendBeforeObservers;
      _emberMetalCore["default"]._suspendObserver =
        _emberMetalObserver._suspendObserver;
      _emberMetalCore["default"]._suspendObservers =
        _emberMetalObserver._suspendObservers;
      _emberMetalCore["default"].beforeObserversFor =
        _emberMetalObserver.beforeObserversFor;
      _emberMetalCore["default"].removeBeforeObserver =
        _emberMetalObserver.removeBeforeObserver;

      _emberMetalCore["default"].IS_BINDING = _emberMetalMixin.IS_BINDING;
      _emberMetalCore["default"].required = _emberMetalMixin.required;
      _emberMetalCore["default"].aliasMethod = _emberMetalMixin.aliasMethod;
      _emberMetalCore["default"].observer = _emberMetalMixin.observer;
      _emberMetalCore["default"].immediateObserver =
        _emberMetalMixin.immediateObserver;
      _emberMetalCore["default"].beforeObserver =
        _emberMetalMixin.beforeObserver;
  ...
  */
      ...
      _emberMetalCore["default"].libraries = new _emberMetalLibraries[
        "default"
      ]();
      _emberMetalCore["default"].libraries.registerCoreLibrary(
        "Ember",
        _emberMetalCore["default"].VERSION
      );
...
*/
  ...
  enifed(
    ...
    function (
      ...
      AliasedProperty.prototype = (0, _emberMetalPlatformCreate["default"])(
        _emberMetalProperties.Descriptor.prototype
      );

      AliasedProperty.prototype.get = function AliasedProperty_get(
        obj,
        keyName
      ) {
      ...
      AliasedProperty.prototype.set = function AliasedProperty_set(
        obj,
        keyName,
        value
      ) {
      ...
      AliasedProperty.prototype.willWatch = function (obj, keyName) {
        (0, _emberMetalDependent_keys.addDependentKeys)(
          this,
          obj,
          keyName,
      ...
      AliasedProperty.prototype.didUnwatch = function (obj, keyName) {
        (0, _emberMetalDependent_keys.removeDependentKeys)(
          this,
          obj,
          keyName,
          (0, _emberMetalUtils.meta)(obj)
      ...
      function AliasedProperty_readOnlySet(obj, keyName, value) {
        throw new _emberMetalError["default"](
          "Cannot set read-only property '" +
            keyName +
            "' on object: " +
            (0, _emberMetalUtils.inspect)(obj)
        );
      }
      ...
      AliasedProperty.prototype.meta =
        _emberMetalComputed.ComputedProperty.prototype.meta;
    }
  );
  // Ember.assert
  ...
  */
    ...
    var isNativeFunc = function (func) {
      ...
      return (
        func &&
        Function.prototype.toString.call(func).indexOf("[native code]") > -1
      );
    };
    ...
    var lastIndexOf = defineNativeShim(
      ...
      function (obj, fromIndex) {
        ...
        if (fromIndex === undefined) {
          ...
          fromIndex =
            fromIndex < 0 ? Math.ceil(fromIndex) : Math.floor(fromIndex);
        }
  ...
  */
    ...
    @public
  */
      _emberMetalCore["default"].LOG_BINDINGS =
        false || !!_emberMetalCore["default"].ENV.LOG_BINDINGS;
  ...
  */
      ...
      function getWithGlobals(obj, path) {
        return (0, _emberMetalProperty_get.get)(
          (0, _emberMetalPath_cache.isGlobal)(path)
  ...
  */
    ...
    */
        toString: function () {
          ...
          return (
            "Ember.Binding<" +
            (0, _emberMetalUtils.guidFor)(this) +
            ">(" +
            this._from +
            " -> " +
            this._to +
    ...
    */
        connect: function (obj) {
          _emberMetalCore["default"].assert(
            "Must pass a valid object to Ember.Binding.connect()",
            !!obj
          );

          var fromPath = this._from;
          var toPath = this._to;
          (0, _emberMetalProperty_set.trySet)(
            obj,
            toPath,
            getWithGlobals(obj, fromPath)
          );

          // add an observer on the object to be notified when the binding should be updated
          (0, _emberMetalObserver.addObserver)(
            obj,
            fromPath,
            this,
            this.fromDidChange
    ...
    */
        disconnect: function (obj) {
          _emberMetalCore["default"].assert(
            "Must pass a valid object to Ember.Binding.disconnect()",
            !!obj
          );
          ...
          (0, _emberMetalObserver.removeObserver)(
            obj,
            this._from,
            this,
            this.fromDidChange
        ...
        _scheduleSync: function (obj, dir) {
          ...
          if (existingDir === undefined) {
            _emberMetalRun_loop["default"].schedule(
              "sync",
              this,
              this._sync,
              obj
        ...
        _sync: function (obj) {
          ...
          if (direction === "fwd") {
            ...
            if (log) {
              _emberMetalCore["default"].Logger.log(
                " ",
                this.toString(),
                "->",
                fromValue,
            ...
            if (this._oneWay) {
              ...
              (0, _emberMetalObserver._suspendObserver)(
                obj,
                toPath,
                this,
                this.toDidChange,
            ...
            (0, _emberMetalObserver._suspendObserver)(
              ...
              function () {
                (0, _emberMetalProperty_set.trySet)(
                  (0, _emberMetalPath_cache.isGlobal)(fromPath)
                    ? _emberMetalCore["default"].lookup
                    : obj,
                  fromPath,
                  toValue
  ...
  */
  ...
  enifed(
    "ember-metal/cache",
    ["exports", "ember-metal/dictionary"],
    function (exports, _emberMetalDictionary) {
  ...
  */
      function ComputedProperty(config, opts) {
        ...
        if (typeof config === "function") {
          ...
          if (config.__ember_arity > 1) {
            Ember.deprecate(
              ...
              {
                url:
                  "http://emberjs.com/deprecations/v1.x/#toc_deprecate-using-the-same-function-as-getter-and-setter-in-computed-properties",
              }
            );
            this._setter = config;
          }
        ...
        Ember.deprecate(
          ...
          !opts || !opts.hasOwnProperty("cacheable")
        );
        this._cacheable =
          opts && opts.cacheable !== undefined ? opts.cacheable : true; // TODO: Set always to `true` once this deprecation is gone.
        ...
        Ember.deprecate(
          ...
          !opts || !opts.hasOwnProperty("readOnly")
        );
        this._readOnly =
          (opts && (opts.readOnly !== undefined || !!opts.readOnly)) || false; // TODO: Set always to `false` once this deprecation is gone.
      }
  ...
  */
    ...
    @public
  */
      ComputedPropertyPrototype.set = function computedPropertySetWithSuspend(
        obj,
        keyName,
        value
      ) {
      ...
      ComputedPropertyPrototype._set = function computedPropertySet(
        obj,
        keyName,
        value
      ) {
        ...
        if (!setter) {
          (0, _emberMetalProperties.defineProperty)(
            obj,
            keyName,
            null,
            cachedValue
  ...
  */
      ...
      function getProperties(self, propertyNames) {
        ...
        for (var i = 0; i < propertyNames.length; i++) {
          ret[propertyNames[i]] = (0, _emberMetalProperty_get.get)(
            self,
            propertyNames[i]
          );
        }
  ...
  */
      ...
      function empty(dependentKey) {
        return (0, _emberMetalComputed.computed)(
          dependentKey + ".length",
          function () {
            return (0, _emberMetalIs_empty["default"])(
              (0, _emberMetalProperty_get.get)(this, dependentKey)
            );
          }
        );
      }
  ...
  */
      var any = generateComputedWithProperties(function (properties) {
        _emberMetalCore["default"].deprecate(
          "Usage of Ember.computed.any is deprecated, use `Ember.computed.or` instead."
        );
        for (var key in properties) {
          if (properties.hasOwnProperty(key) && properties[key]) {
            return properties[key];
        ...
        return (0, _emberMetalComputed.computed)({
          ...
          set: function (key, newValue, cachedValue) {
            ...
            return newValue != null
              ? newValue
              : (0, _emberMetalProperty_get.get)(this, defaultPath);
          },
        });
      }
  ...
  */
    ...
    [Ember-Runtime](http://emberjs.com/modules/ember-runtime.html).
  ...
  */
    ...
    if (Ember.ENV) {
      ...
      Ember.assert(
        "Ember.ENV should be an object.",
        "object" !== typeof Ember.ENV
      );
  ...
  */
    Ember.FEATURES = {
      ...
      "ember-htmlbars-get-helper": false,
  ...
  */
  ...
  enifed(
    "ember-metal/dependent_keys",
    ["exports", "ember-metal/platform/create", "ember-metal/watching"],
    function (exports, _emberMetalPlatformCreate, _emberMetalWatching) {
  ...
  */
      function keysForDep(depsMeta, depKey) {
        ...
        if (!keys) {
          ...
          keys = depsMeta[depKey] = (0, _emberMetalPlatformCreate["default"])(
            keys
          );
        }
        return keys;
...
*/
  enifed(
    ...
    ["exports", "ember-metal/platform/create"],
    function (exports, _emberMetalPlatformCreate) {
  ...
  enifed(
    "ember-metal/enumerable_utils",
    ["exports", "ember-metal/core", "ember-metal/array"],
    function (exports, _emberMetalCore, _emberMetalArray) {
      exports.map = map;
      exports.forEach = forEach;
      exports.filter = filter;
      exports.indexOf = indexOf;
  ...
  */
      ...
      function map(obj, callback, thisArg) {
        return obj.map
          ...
          : _emberMetalArray.map.call(obj, callback, thisArg);
      }

      var deprecatedMap = _emberMetalCore["default"].deprecateFunc(
        "Ember.EnumberableUtils.map is deprecated, please refactor to use Array.prototype.map.",
        map
      );
  ...
  */
      ...
      function forEach(obj, callback, thisArg) {
        return obj.forEach
          ...
          : _emberMetalArray.forEach.call(obj, callback, thisArg);
      }

      var deprecatedForEach = _emberMetalCore["default"].deprecateFunc(
        "Ember.EnumberableUtils.forEach is deprecated, please refactor to use Array.prototype.forEach.",
        forEach
      );
  ...
  */
      ...
      function filter(obj, callback, thisArg) {
        return obj.filter
          ...
          : _emberMetalArray.filter.call(obj, callback, thisArg);
      }

      var deprecatedFilter = _emberMetalCore["default"].deprecateFunc(
        "Ember.EnumberableUtils.filter is deprecated, please refactor to use Array.prototype.filter.",
        filter
      );
  ...
  */
      ...
      function indexOf(obj, element, index) {
        return obj.indexOf
          ? obj.indexOf(element, index)
          : _emberMetalArray.indexOf.call(obj, element, index);
      }

      var deprecatedIndexOf = _emberMetalCore["default"].deprecateFunc(
        "Ember.EnumberableUtils.indexOf is deprecated, please refactor to use Array.prototype.indexOf.",
        indexOf
      );
  ...
  */
      ...
      var deprecatedIndexesOf = _emberMetalCore["default"].deprecateFunc(
        "Ember.EnumerableUtils.indexesOf is deprecated.",
        indexesOf
      );
  ...
  */
      ...
      var deprecatedAddObject = _emberMetalCore["default"].deprecateFunc(
        "Ember.EnumerableUtils.addObject is deprecated.",
        addObject
      );
  ...
  */
      ...
      var deprecatedRemoveObject = _emberMetalCore["default"].deprecateFunc(
        "Ember.EnumerableUtils.removeObject is deprecated.",
        removeObject
      );
  ...
  */
      ...
      var deprecatedReplace = _emberMetalCore["default"].deprecateFunc(
        "Ember.EnumerableUtils.replace is deprecated.",
        replace
      );
  ...
  */
      ...
      var deprecatedIntersection = _emberMetalCore["default"].deprecateFunc(
        "Ember.EnumerableUtils.intersection is deprecated.",
        intersection
      );
  ...
  */
      ...
      var hasDOM =
        ...
        !_emberMetalCore["default"].ENV.disableBrowserEnvironment;
  ...
  */
      ...
      EmberError.prototype = (0, _emberMetalPlatformCreate["default"])(
        Error.prototype
      );
  ...
  */
      ...
      function actionsFor(obj, eventName) {
        ...
        if (!listeners) {
          ...
          _emberMetalPlatformCreate["default"])(null);
          listeners.__source__ = obj;
        } else if (listeners.__source__ !== obj) {
          // setup inherited copy of the listeners object
          listeners = meta.listeners = (0,
          _emberMetalPlatformCreate["default"])(listeners);
          listeners.__source__ = obj;
        }
  ...
  */
      function removeListener(obj, eventName, target, method) {
        _emberMetalCore["default"].assert(
          "You must pass at least an object and event name to Ember.removeListener",
          !!obj && !!eventName
        );
...
*/
  enifed(
    "ember-metal/expand_properties",
    ["exports", "ember-metal/error", "ember-metal/array"],
    function (exports, _emberMetalError, _emberMetalArray) {
  ...
  */
      ...
      function expandProperties(pattern, callback) {
        ...
        if ("string" === typeof pattern) {
          ...
          _emberMetalArray.forEach.call(parts, function (part, index) {
            if (part.indexOf(",") >= 0) {
              properties = duplicateAndReplace(
                properties,
                part.split(","),
                index
              );
  ...
  enifed(
    "ember-metal/get_properties",
    ["exports", "ember-metal/property_get", "ember-metal/utils"],
  ...
  */
      ...
      function getProperties(obj) {
        ...
        if (
          arguments.length === 2 &&
          (0, _emberMetalUtils.isArray)(arguments[1])
        ) {
          i = 0;
  ...
  */
      ...
      InjectedProperty.prototype = (0, _emberMetalPlatformCreate["default"])(
        _emberMetalProperties.Descriptor.prototype
      );

      var InjectedPropertyPrototype = InjectedProperty.prototype;
      var ComputedPropertyPrototype =
        _emberMetalComputed.ComputedProperty.prototype;
      var AliasedPropertyPrototype = _emberMetalAlias.AliasedProperty.prototype;

      InjectedPropertyPrototype._super$Constructor =
        _emberMetalComputed.ComputedProperty;
  ...
  enifed(
    "ember-metal/instrumentation",
    ["exports", "ember-metal/core", "ember-metal/utils"],
    function (exports, _emberMetalCore, _emberMetalUtils) {
  ...
  */
      ...
      function instrument(name, _payload, callback, binding) {
        ...
        if (finalizer) {
          ...
          return (0, _emberMetalUtils.tryCatchFinally)(
            tryable,
            catchable,
            finalizer
          );
  ...
  */
      ...
      function isBlank(obj) {
        return (
          (0, _emberMetalIs_empty["default"])(obj) ||
  ...
  enifed(
    "ember-metal/is_empty",
    ["exports", "ember-metal/property_get", "ember-metal/is_none"],
  ...
  */
  ...
  enifed(
    "ember-metal/keys",
    ["exports", "ember-metal/platform/define_property"],
    function (exports, _emberMetalPlatformDefine_property) {
      /**
  ...
  */
      ...
      if (
        !keys ||
        !_emberMetalPlatformDefine_property.canDefineNonEnumerableProperties
      ) {
        // modified from
  ...
  enifed(
    "ember-metal/libraries",
    ["exports", "ember-metal/core", "ember-metal/enumerable_utils"],
    function (exports, _emberMetalCore, _emberMetalEnumerable_utils) {
      /**
  ...
  */
      ...
      Libraries.prototype = {
        ...
        deRegister: function (name) {
          ...
          if (lib) {
            index = (0, _emberMetalEnumerable_utils.indexOf)(
              this._registry,
              lib
            );
        ...
        each: function (callback) {
          ...
          (0, _emberMetalEnumerable_utils.forEach)(
            this._registry,
            function (lib) {
  ...
  enifed(
    "ember-metal/logger",
    ["exports", "ember-metal/core", "ember-metal/error"],
  ...
  */
    ...
    */
      ...
      (0, _emberMetalDeprecate_property.deprecateProperty)(
        OrderedSet.prototype,
        "length",
        "size"
      );
  ...
  */
      ...
      MapWithDefault.prototype = (0, _emberMetalPlatformCreate["default"])(
        Map.prototype
      );
...
*/
  enifed(
    "ember-metal/merge",
    ["exports", "ember-metal/keys"],
    function (exports, _emberMetalKeys) {
  ...
  enifed(
    ...
    function (
      ...
      function concatenatedMixinProperties(concatProp, props, values, base) {
        ...
        if (props[concatProp]) {
          concats = concats
            ? concats.concat(props[concatProp])
            : props[concatProp];
        }
      ...
      function giveDescriptorSuper(meta, key, property, values, descs, base) {
        ...
        if (
          ...
          !(superProperty instanceof _emberMetalComputed.ComputedProperty)
        ) {
          return property;
        }
        ...
        property._getter = (0, _emberMetalUtils.wrap)(
          property._getter,
          superProperty._getter
        );
        if (superProperty._setter) {
          if (property._setter) {
            property._setter = (0, _emberMetalUtils.wrap)(
              property._setter,
              superProperty._setter
            );
          } else {
      ...
      function applyMergedProperties(obj, key, value, values) {
        ...
        _emberMetalCore["default"].assert(
          "You passed in `" +
            ...
            key +
            "` cannot be an Array",
          !(0, _emberMetalUtils.isArray)(value)
        );
      ...
      function addNormalizedProperty(
        ...
        if (value instanceof _emberMetalProperties.Descriptor) {
          ...
          if (
            (concats && _emberMetalArray.indexOf.call(concats, key) >= 0) ||
            ...
            mergings &&
            _emberMetalArray.indexOf.call(mergings, key) >= 0
          ) {
      ...
      function mergeMixins(mixins, m, descs, values, base, keys) {
        ...
        for (var i = 0, l = mixins.length; i < l; i++) {
          ...
          _emberMetalCore["default"].assert(
            "Expected hash or Mixin instance, got " +
              Object.prototype.toString.call(currentMixin),
      ...
      function detectBinding(obj, key, value, m) {
        if (IS_BINDING.test(key)) {
          ...
          if (!bindings) {
            ...
            bindings = m.bindings = (0, _emberMetalPlatformCreate["default"])(
              m.bindings
            );
          }
          bindings[key] = value;
      ...
      function connectStreamBinding(obj, key, stream) {
        ...
        if (obj._streamBindingSubscriptions === undefined) {
          obj._streamBindingSubscriptions = (0,
          _emberMetalPlatformCreate["default"])(null);
        }
  ...
  */
      ...
      function observer() {
        ...
        for (var i = 0; i < _paths.length; ++i) {
          (0, _emberMetalExpand_properties["default"])(
            _paths[i],
            addWatchedProperty
          );
        }
        ...
        if (typeof func !== "function") {
          throw new _emberMetalCore["default"].Error(
  ...
  */
      ...
      function immediateObserver() {
        _emberMetalCore["default"].deprecate(
          "Usage of `Ember.immediateObserver` is deprecated, use `Ember.observer` instead."
        );
  ...
  */
      ...
      function beforeObserver() {
        ...
        if (typeof func !== "function") {
          throw new _emberMetalCore["default"].Error(
            "Ember.beforeObserver called without a function"
          );
        }
...
*/
  ...
  */
      ...
      function addObserver(obj, _path, target, method) {
        (0, _emberMetalEvents.addListener)(
          obj,
          changeEvent(_path),
          target,
          method
  ...
  */
      ...
      function removeObserver(obj, path, target, method) {
        ...
        (0, _emberMetalEvents.removeListener)(
          obj,
          changeEvent(path),
          target,
          method
  ...
  */
      ...
      function _suspendBeforeObserver(obj, path, target, method, callback) {
        return (0, _emberMetalEvents.suspendListener)(
          obj,
          beforeEvent(path),
          target,
          method,
      ...
      function _suspendBeforeObservers(obj, paths, target, method, callback) {
        ...
        return (0, _emberMetalEvents.suspendListeners)(
          obj,
          events,
          target,
          method,
  ...
  */
  ...
  enifed(
    "ember-metal/observer_set",
    ["exports", "ember-metal/utils", "ember-metal/events"],
  ...
  */
      ...
      ObserverSet.prototype.flush = function () {
        ...
        for (i = 0, len = observers.length; i < len; ++i) {
          ...
          (0, _emberMetalEvents.sendEvent)(
            sender,
            observer.eventName,
            [sender, observer.keyName],
            observer.listeners
          );
        }
      };
  ...
  enifed(
    ...
    function (exports, _emberMetalCache) {
      ...
      var isGlobalPathCache = new _emberMetalCache["default"](
        1000,
        function (key) {
      ...
      var firstDotIndexCache = new _emberMetalCache["default"](
        1000,
        function (key) {
          return key.indexOf(".");
        }
      ...
      var firstKeyCache = new _emberMetalCache["default"](
        1000,
        function (path) {
  ...
  enifed(
    "ember-metal/platform/create",
    ["exports", "ember-metal/platform/define_properties"],
    function (exports, _emberMetalPlatformDefine_properties) {
      // Remove "use strict"; from transpiled module until
      // https://bugs.webkit.org/show_bug.cgi?id=138038 is fixed
      //
      "REMOVE_USE_STRICT: true";
      ...
      if (!(Object.create && !Object.create(null).hasOwnProperty)) {
        ...
        create = Object.create = function create(prototype, properties) {
          ...
          if (properties !== undefined) {
            (0, _emberMetalPlatformDefine_properties["default"])(
              object,
              properties
            );
          }
        ...
        defineProperties = function defineProperties(object, properties) {
          for (var property in properties) {
            if (
              ...
              (0, _emberMetalPlatformDefine_property.defineProperty)(
                object,
                property,
                properties[property]
              );
  ...
  */
      ...
      if (hasES5CompliantDefineProperty && typeof document !== "undefined") {
        ...
        if (!canDefinePropertyOnDOM) {
          exports.defineProperty = defineProperty = function (
            obj,
            keyName,
            desc
          ) {
      ...
      if (!hasES5CompliantDefineProperty) {
        exports.defineProperty = defineProperty = function definePropertyPolyfill(
          obj,
          keyName,
          desc
        ) {
  ...
  */
      ...
      function MANDATORY_SETTER_FUNCTION(name) {
        return function SETTER_FUNCTION(value) {
          _emberMetalCore["default"].assert(
            "You must use Ember.set() to set the `" +
              name +
              "` property (of " +
              this +
              ") to `" +
  ...
  */
      ...
      function defineProperty(obj, keyName, desc, data, meta) {
        ...
        if (desc instanceof Descriptor) {
          ...
          if (
            _emberMetalCore["default"].FEATURES.isEnabled("mandatory-setter")
          ) {
            if (
              watching &&
              _emberMetalPlatformDefine_property.hasPropertyAccessors
...
*/
  enifed(
    ...
    function (
      ...
      var PROPERTY_DID_CHANGE = (0, _emberMetalUtils.symbol)(
        "PROPERTY_DID_CHANGE"
      );
  ...
  */
      ...
      function chainsDidChange(obj, keyName, m, suppressEvents) {
        if (
          !(m && m.hasOwnProperty("chainWatchers") && m.chainWatchers[keyName])
        ) {
          return;
        }
  ...
  */
      ...
      function notifyBeforeObservers(obj, keyName) {
        ...
        if (deferred) {
          ...
          added = (0, _emberMetalEvents.accumulateListeners)(
            obj,
            eventName,
            listeners
          );
  ...
  */
      ...
      function get(obj, keyName) {
        ...
        _emberMetalCore["default"].assert(
          "Cannot call get with " + keyName + " key.",
          !!keyName
        );
        _emberMetalCore["default"].assert(
  ...
  */
      ...
      function validateIsPath(path) {
        if (!path || path.length === 0) {
          throw new _emberMetalError["default"](
            "Object in path " + path + " could not be found or was destroyed."
          );
        }
      }
...
*/
  ...
  */
      ...
      function set(obj, keyName, value, tolerant) {
        if (typeof obj === "string") {
          _emberMetalCore["default"].assert(
            "Path '" + obj + "' must be global if no obj is given.",
            (0, _emberMetalPath_cache.isGlobalPath)(obj)
          );
          value = keyName;
          keyName = obj;
          obj = _emberMetalCore["default"].lookup;
        ...
        _emberMetalCore["default"].assert(
          "Cannot call set with '" + keyName + "' key.",
          !!keyName
        );
        ...
        if (
          (!obj || desc === undefined) &&
          (0, _emberMetalPath_cache.isPath)(keyName)
        ) {
          return setPath(obj, keyName, value, tolerant);
        }
      ...
      function setPath(root, path, value, tolerant) {
        ...
        path =
          path === keyName
            ? keyName
            : path.slice(0, path.length - (keyName.length + 1));
        ...
        if (!root) {
          if (tolerant) {
            ...
            throw new _emberMetalError["default"](
              'Property set failed: object in path "' +
                path +
                '" could not be found or was destroyed.'
            );
          }
        }
  ...
  */
  ...
  enifed(
    ...
    function (
      ...
      var backburner = new _backburner["default"](
  ...
  */
      run.bind = function () {
        for (
          var _len = arguments.length, curried = Array(_len), _key = 0;
          _key < _len;
          _key++
        ) {
      ...
      function checkAutoRun() {
        if (!run.currentRunLoop) {
          _emberMetalCore["default"].assert(
            ...
            !_emberMetalCore["default"].testing
          );
        }
      }
  ...
  */
      run._addQueue = function (name, after) {
        if (_emberMetalArray.indexOf.call(run.queues, name) === -1) {
          run.queues.splice(
            _emberMetalArray.indexOf.call(run.queues, after) + 1,
            0,
            name
          );
        }
  ...
  ); /*target, method*/ /*queue, target, method*/
  /* queue, target, method */ enifed(
    "ember-metal/set_properties",
    [
      "exports",
      "ember-metal/property_events",
  ...
  */
  ...
  enifed(
    ...
    function (
      ...
      ConditionalStream.prototype = (0, _emberMetalPlatformCreate["default"])(
        _emberMetalStreamsStream["default"].prototype
      );
      ...
      ConditionalStream.prototype.compute = function () {
        ...
        if (newTestResult !== oldTestResult) {
          switch (oldTestResult) {
            case true:
              (0, _emberMetalStreamsUtils.unsubscribe)(
                this.consequent,
                this.notify,
                this
              );
            ...
            case false:
              ...
              break;
            case undefined:
              (0, _emberMetalStreamsUtils.subscribe)(
                this.test,
                this.notify,
                this
              );
        ...
        return newTestResult
          ? (0, _emberMetalStreamsUtils.read)(this.consequent)
          : (0, _emberMetalStreamsUtils.read)(this.alternate);
      };
    }
  );
  enifed(
    "ember-metal/streams/dependency",
    [
      "exports",
      "ember-metal/core",
      "ember-metal/merge",
  ...
  */
      function Dependency(depender, dependee) {
        _emberMetalCore["default"].assert(
          "Dependency error: Depender must be a stream",
          (0, _emberMetalStreamsUtils.isStream)(depender)
        );
      ...
      (0, _emberMetalMerge["default"])(Dependency.prototype, {
        subscribe: function () {
          _emberMetalCore["default"].assert(
            "Dependency error: Dependency tried to subscribe while already subscribed",
            !this.unsubscription
          );

          this.unsubscription = (0, _emberMetalStreamsUtils.subscribe)(
            this.dependee,
            this.depender.notify,
            this.depender
          );
        },
  ...
  enifed(
    ...
    function (
      ...
      function KeyStream(source, key) {
        _emberMetalCore["default"].assert(
          "KeyStream error: source must be a stream",
          (0, _emberMetalStreamsUtils.isStream)(source)
        ); // TODO: This isn't necessary.
        _emberMetalCore["default"].assert(
          "KeyStream error: key must be a non-empty string",
          typeof key === "string" && key.length > 0
        );
        _emberMetalCore["default"].assert(
          "KeyStream error: key must not have a '.'",
          key.indexOf(".") === -1
        );
      ...
      KeyStream.prototype = (0, _emberMetalPlatformCreate["default"])(
        _emberMetalStreamsStream["default"].prototype
      );
      ...
      (0, _emberMetalMerge["default"])(KeyStream.prototype, {
        ...
        _super$revalidate:
          _emberMetalStreamsStream["default"].prototype.revalidate,
        ...
        _super$deactivate:
          _emberMetalStreamsStream["default"].prototype.deactivate,
  ...
  enifed(
    "ember-metal/streams/proxy-stream",
    [
      "exports",
      "ember-metal/merge",
      "ember-metal/streams/stream",
    ...
    function (
      ...
      ProxyStream.prototype = (0, _emberMetalPlatformCreate["default"])(
        _emberMetalStreamsStream["default"].prototype
      );
  ...
  enifed(
    ...
    [
      ...
      "ember-metal/observer",
      "ember-metal/streams/utils",
      "ember-metal/streams/subscriber",
      "ember-metal/streams/dependency",
    ],
    function (
      exports,
  ...
  */
      ...
      Stream.prototype = {
        ...
        _makeChildStream: function (key) {
          KeyStream =
            KeyStream ||
            _emberMetalCore["default"].__loader.require(
              "ember-metal/streams/key-stream"
            )["default"];
        ...
        addMutableDependency: function (object) {
          var dependency = new _emberMetalStreamsDependency["default"](
            this,
            object
          );
        ...
        subscribe: function (callback, context) {
          _emberMetalCore["default"].assert(
            "You tried to subscribe to a stream but the callback provided was not a function.",
            typeof callback === "function"
          );

          var subscriber = new _emberMetalStreamsSubscriber["default"](
            callback,
            context,
            this
          );
  ...
  enifed(
    "ember-metal/streams/subscriber",
    ["exports", "ember-metal/merge"],
    function (exports, _emberMetalMerge) {
      /**
    @module ember-metal
  */
   ...
   */
      ...
      function labelFor(maybeStream) {
        if (isStream(maybeStream)) {
          ...
          return typeof stream.label === "function"
            ? stream.label()
            : stream.label;
        } else {
      ...
      function addDependency(stream, dependency) {
        Ember.assert(
          "Cannot add a stream as a dependency to a non-stream",
          isStream(stream) || !isStream(dependency)
        );
        if (isStream(stream)) {
  ...
  */
      function meta(obj, writable) {
        ...
        if (!ret) {
          ...
          ret.watching = (0, _emberMetalPlatformCreate["default"])(
            ret.watching
          );
          ret.cache = undefined;
          ...
          if (
            ...
            if (_emberMetalPlatformDefine_property.hasPropertyAccessors) {
              ret.values = (0, _emberMetalPlatformCreate["default"])(
                ret.values
              );
            }
          }
  ...
  */
      ...
      function metaPath(obj, path, writable) {
        _emberMetalCore["default"].deprecate(
          "Ember.metaPath is deprecated and will be removed from future releases."
        );
        ...
        for (var i = 0, l = path.length; i < l; i++) {
          ...
          if (!value) {
            ...
            value = _meta[keyName] = (0, _emberMetalPlatformCreate["default"])(
              value
            );
  ...
  */
      ...
      function tryInvoke(obj, methodName, args) {
        if (canInvoke(obj, methodName)) {
          return args
            ? applyStr(obj, methodName, args)
            : applyStr(obj, methodName);
        }
      }
  ...
  */
      ...
      var tryFinally;
      if (needsFinallyFix) {
        exports.tryFinally = tryFinally = function (
          tryable,
          finalizer,
          binding
        ) {
      ...
      var deprecatedTryFinally = function () {
        _emberMetalCore["default"].deprecate(
          "tryFinally is deprecated. Please use JavaScript's native try/finally.",
          false
        );
  ...
  */
      var tryCatchFinally;
      if (needsFinallyFix) {
        exports.tryCatchFinally = tryCatchFinally = function (
          tryable,
          catchable,
          finalizer,
          binding
      ...
      var deprecatedTryCatchFinally = function () {
        _emberMetalCore["default"].deprecate(
          "tryCatchFinally is deprecated. Please use JavaScript's native try/catch/finally.",
          false
        );
  ...
  */
  ...
  enifed(
    ...
    function (
      ...
      if (_emberMetalCore["default"].FEATURES.isEnabled("mandatory-setter")) {
        var handleMandatorySetter = function handleMandatorySetter(
          m,
          obj,
          keyName
        ) {
          ...
          if (configurable && isWritable && hasValue && keyName in obj) {
            ...
            (0, _emberMetalPlatformDefine_property.defineProperty)(
              ...
              keyName,
              {
                ...
                set: (0, _emberMetalProperties.MANDATORY_SETTER_FUNCTION)(
                  keyName
                ),
                get: (0, _emberMetalProperties.DEFAULT_GETTER_FUNCTION)(
                  keyName
                ),
              }
            );
  ...
  enifed(
    "ember-metal/watch_path",
    ["exports", "ember-metal/utils", "ember-metal/chains"],
    function (exports, _emberMetalUtils, _emberMetalChains) {
          ...
          if (node) {
            ...
            while (NODE_STACK.length > 0) {
              ...
              if (node._watching) {
                ...
                if (nodeObject) {
                  (0, _emberMetalChains.removeChainWatcher)(
                    nodeObject,
                    node._key,
                    node
                  );
...
*/
  enifed(
    ...
    [
      ...
      "ember-template-compiler/plugins/transform-each-in-to-block-params",
      "ember-template-compiler/plugins/transform-with-as-to-hash",
      "ember-template-compiler/plugins/transform-bind-attr-to-attributes",
      "ember-template-compiler/plugins/transform-each-into-collection",
      "ember-template-compiler/plugins/transform-single-arg-each",
      "ember-template-compiler/plugins/transform-old-binding-syntax",
      "ember-template-compiler/plugins/transform-old-class-binding-syntax",
      "ember-template-compiler/plugins/transform-item-class",
      "ember-template-compiler/plugins/transform-component-attrs-into-mut",
      "ember-template-compiler/plugins/transform-component-curly-to-readonly",
      "ember-template-compiler/plugins/transform-angle-bracket-components",
      "ember-template-compiler/plugins/transform-input-on-to-onEvent",
      "ember-template-compiler/plugins/deprecate-view-and-controller-paths",
      "ember-template-compiler/plugins/deprecate-view-helper",
    ...
    function (
      ...
      _emberTemplateCompilerPluginsTransformEachInToBlockParams,
      _emberTemplateCompilerPluginsTransformWithAsToHash,
      _emberTemplateCompilerPluginsTransformBindAttrToAttributes,
      _emberTemplateCompilerPluginsTransformEachIntoCollection,
      _emberTemplateCompilerPluginsTransformSingleArgEach,
      ...
      _emberTemplateCompilerPluginsDeprecateViewHelper,
      _emberTemplateCompilerCompat
    ) {
      (0, _emberTemplateCompilerPlugins.registerPlugin)(
        "ast",
        _emberTemplateCompilerPluginsTransformWithAsToHash["default"]
      );
      (0, _emberTemplateCompilerPlugins.registerPlugin)(
        "ast",
        _emberTemplateCompilerPluginsTransformEachInToBlockParams["default"]
      );
      (0, _emberTemplateCompilerPlugins.registerPlugin)(
        "ast",
        _emberTemplateCompilerPluginsTransformBindAttrToAttributes["default"]
      );
      (0, _emberTemplateCompilerPlugins.registerPlugin)(
        "ast",
        _emberTemplateCompilerPluginsTransformSingleArgEach["default"]
      );
      (0, _emberTemplateCompilerPlugins.registerPlugin)(
        "ast",
        _emberTemplateCompilerPluginsTransformEachIntoCollection["default"]
      );
      (0, _emberTemplateCompilerPlugins.registerPlugin)(
        "ast",
        _emberTemplateCompilerPluginsTransformOldBindingSyntax["default"]
      );
      (0, _emberTemplateCompilerPlugins.registerPlugin)(
        "ast",
        _emberTemplateCompilerPluginsTransformOldClassBindingSyntax["default"]
      );
      (0, _emberTemplateCompilerPlugins.registerPlugin)(
        "ast",
        _emberTemplateCompilerPluginsTransformItemClass["default"]
      );
      (0, _emberTemplateCompilerPlugins.registerPlugin)(
        "ast",
        _emberTemplateCompilerPluginsTransformComponentAttrsIntoMut["default"]
      );
      (0, _emberTemplateCompilerPlugins.registerPlugin)(
        "ast",
        _emberTemplateCompilerPluginsTransformComponentCurlyToReadonly[
      ...
      (0, _emberTemplateCompilerPlugins.registerPlugin)(
        "ast",
        _emberTemplateCompilerPluginsTransformAngleBracketComponents["default"]
      );
      (0, _emberTemplateCompilerPlugins.registerPlugin)(
        "ast",
        _emberTemplateCompilerPluginsTransformInputOnToOnEvent["default"]
      );
      (0, _emberTemplateCompilerPlugins.registerPlugin)(
        "ast",
        _emberTemplateCompilerPluginsDeprecateViewAndControllerPaths["default"]
      );
      (0, _emberTemplateCompilerPlugins.registerPlugin)(
        "ast",
        _emberTemplateCompilerPluginsDeprecateViewHelper["default"]
      );
  ...
  enifed(
    ...
    function (
      ...
      var EmberHandlebars = (_emberMetalCore["default"].Handlebars =
        _emberMetalCore["default"].Handlebars || {});

      EmberHandlebars.precompile =
        _emberTemplateCompilerCompatPrecompile["default"];
      EmberHandlebars.compile = _emberTemplateCompilerSystemCompile["default"];
      EmberHandlebars.template =
        _emberTemplateCompilerSystemTemplate["default"];
    }
  );
  enifed(
    "ember-template-compiler/compat/precompile",
    ["exports", "ember-template-compiler/system/compile_options"],
    function (exports, _emberTemplateCompilerSystemCompile_options) {
      var compile, compileSpec;

      exports["default"] = function (string) {
        if (
          (!compile || !compileSpec) &&
          Ember.__loader.registry["htmlbars-compiler/compiler"]
        ) {
        ...
        if (!compile || !compileSpec) {
          throw new Error(
            "Cannot call `precompile` without the template compiler loaded. Please load `ember-template-compiler.js` prior to calling `precompile`."
          );
        }
        ...
        return compileFunc(
          string,
          (0, _emberTemplateCompilerSystemCompile_options["default"])()
        );
      };
    }
  );
...
*/
      ...
      if (!plugins[type]) {
        throw new Error(
          'Attempting to register "' +
            ...
            '" as "' +
            type +
            '" which is not a valid HTMLBars plugin type.'
        );
      }
  ...
  */
      DeprecateViewAndControllerPaths.prototype.transform = function DeprecateViewAndControllerPaths_transform(
        ast
      ) {
      ...
      function deprecatePath(moduleName, node, path) {
        _emberMetalCore["default"].deprecate(
          "Using `{{" +
            (path && path.type === "PathExpression" && path.parts[0]) +
            "}}` or any path based on it " +
            (0,
            _emberTemplateCompilerSystemCalculateLocationDisplay["default"])(
              moduleName,
              node.loc
            ) +
            "has been deprecated.",
          function deprecatePath_test() {
          ...
          {
            url:
              "http://emberjs.com/deprecations/v1.x#toc_view-and-controller-template-keywords",
            id:
              path.parts && path.parts[0] === "view"
                ? "view.keyword.view"
                : "view.keyword.controller",
          }
        );
      }
  ...
  enifed(
    ...
    @param {AST} ast The AST to be transformed.
  */
      DeprecateViewHelper.prototype.transform = function DeprecateViewHelper_transform(
        ast
      ) {
  ...
  enifed(
    ...
    @param {AST} ast The AST to be transformed.
  */
      TransformAngleBracketComponents.prototype.transform = function TransformBindAttrToAttributes_transform(
        ast
      ) {
        var walker = new this.syntax.Walker();
  ...
  enifed(
    ...
    [
      "exports",
      "ember-metal/core",
      "ember-template-compiler/system/string",
      "ember-template-compiler/system/calculate-location-display",
    ],
    function (
      exports,
  ...
  */
    ...
    @param {AST} ast The AST to be transformed.
  */
      TransformBindAttrToAttributes.prototype.transform = function TransformBindAttrToAttributes_transform(
        ast
      ) {
        var plugin = this;
      ...
      TransformBindAttrToAttributes.prototype.assignAttrs = function assignAttrs(
        element,
        hash
      ) {
        ...
        for (var i = 0; i < pairs.length; i++) {
          ...
          var attr = this.syntax.builders.attr(
            name,
            this.transformValue(name, value)
          );
          element.attributes.push(attr);
        }
      };

      TransformBindAttrToAttributes.prototype.transformValue = function transformValue(
        name,
        value
      ) {
        ...
        if (name === "class") {
          switch (value.type) {
            ...
            default:
              _emberMetalCore["default"].assert(
                "Unsupported attribute value type: " + value.type
              );
          }
        } else {
          switch (value.type) {
      ...
      TransformBindAttrToAttributes.prototype.parseClasses = function parseClasses(
        value
      ) {
        var b = this.syntax.builders;
      ...
      TransformBindAttrToAttributes.prototype.parseClass = function parseClass(
        value
      ) {
        var b = this.syntax.builders;
        ...
        switch (parts.length) {
          ...
          default:
            _emberMetalCore["default"].assert(
              "Unsupported bind-attr class syntax: `" + value + "`"
            );
        }
      };
      ...
      function dasherizeLastKey(path) {
        ...
        return (0, _emberTemplateCompilerSystemString.dasherize)(
...
*/
  ...
  enifed(
    ...
    @param {AST} ast The AST to be transformed.
  */
      TransformComponentAttrsIntoMut.prototype.transform = function TransformBindAttrToAttributes_transform(
        ast
      ) {
        var b = this.syntax.builders;
        var walker = new this.syntax.Walker();
  ...
  enifed(
    ...
    @param {AST} ast The AST to be transformed.
  */
      TransformComponentCurlyToReadonly.prototype.transform = function TransformComponetnCurlyToReadonly_transform(
        ast
      ) {
        var b = this.syntax.builders;
        var walker = new this.syntax.Walker();
  ...
  */
    ...
    @param {AST} ast The AST to be transformed.
  */
      TransformEachInToBlockParams.prototype.transform = function TransformEachInToBlockParams_transform(
        ast
      ) {
        var b = this.syntax.builders;
        var walker = new this.syntax.Walker();
        ...
        walker.visit(ast, function (node) {
          if (validate(node)) {
            ...
            _emberMetalCore[
              ...
              "Using the '{{#each item in model}}' form of the {{#each}} helper " +
                moduleInfo +
                "is deprecated. " +
              ...
              {
                url:
                  "http://emberjs.com/guides/deprecations/#toc_code-in-code-syntax-for-code-each-code",
              }
            );
          }
        });
  ...
  */
    ...
    @param {AST} ast The AST to be transformed.
  */
      TransformEachInToHash.prototype.transform = function TransformEachInToHash_transform(
        ast
      ) {
      ...
      TransformEachInToHash.prototype.validate = function TransformEachInToHash_validate(
        node
      ) {
        return (
          (node.type === "BlockStatement" ||
  ...
  enifed(
    ...
    function (
      ...
      TransformEachIntoCollection.prototype.transform = function TransformEachIntoCollection_transform(
        ast
      ) {
        var moduleName = this.options.moduleName;
        var b = this.syntax.builders;
        ...
        walker.visit(ast, function (node) {
          ...
          _emberMetalCore["default"].deprecate(
            "Using '" +
              ...
              "' with '{{each}}' " +
              moduleInfo +
              "is deprecated.  Please refactor to a component."
          );
  ...
  */
    ...
    @param {AST} ast The AST to be transformed.
  */
      TransformInputOnToOnEvent.prototype.transform = function TransformInputOnToOnEvent_transform(
        ast
      ) {
        var pluginContext = this;
        var b = pluginContext.syntax.builders;
        ...
        walker.visit(ast, function (node) {
          if (pluginContext.validate(node)) {
            ...
            if (normalizedOn && normalizedOn.value.type !== "StringLiteral") {
              _emberMetalCore["default"].deprecate(
                "Using a dynamic value for '#{normalizedOn.key}=' with the '{{input}}' helper " +
                  moduleInfo +
                  "is deprecated."
              );
            ...
            var specifiedOn = normalizedOn
              ? "" + normalizedOn.key + '="' + normalizedOn.value.value + '" '
              : "";
            ...
            var expected =
              "" +
              (normalizedOn ? normalizedOn.value.value : "enter") +
              '="' +
            ...
            node.hash.pairs.push(
              b.pair(normalizedOn.value.value, action.value)
            );
          }
        });
      ...
      TransformInputOnToOnEvent.prototype.validate = function TransformWithAsToHash_validate(
        node
      ) {
        return (
          node.type === "MustacheStatement" &&
  ...
  enifed(
    ...
    function (exports) {
      ...
      TransformItemClass.prototype.transform = function TransformItemClass_transform(
        ast
      ) {
        var b = this.syntax.builders;
        var walker = new this.syntax.Walker();
  ...
  enifed(
    ...
    function (
      ...
      TransformOldBindingSyntax.prototype.transform = function TransformOldBindingSyntax_transform(
        ast
      ) {
        var moduleName = this.options.moduleName;
        var b = this.syntax.builders;
  ...
  enifed(
    ...
    function (exports) {
      ...
      TransformOldClassBindingSyntax.prototype.transform = function TransformOldClassBindingSyntax_transform(
        ast
      ) {
        var b = this.syntax.builders;
        var walker = new this.syntax.Walker();
          ...
          if (propName === "") {
            ...
            if (activeClass) {
              ...
              if (inactiveClass !== undefined) {
                hash.pairs.push(
                  b.pair("inactiveClass", b.string(inactiveClass))
                );
              }

              params.push(
                b.sexpr(b.string("-normalize-class"), sexprParams, hash)
              );
            }
  ...
  enifed(
    ...
    function (exports) {
      ...
      TransformSingleArgEach.prototype.transform = function TransformSingleArgEach_transform(
        ast
      ) {
        var b = this.syntax.builders;
        var walker = new this.syntax.Walker();
  ...
  enifed(
    "ember-template-compiler/plugins/transform-with-as-to-hash",
    ["exports", "ember-template-compiler/system/calculate-location-display"],
    function (exports, _emberTemplateCompilerSystemCalculateLocationDisplay) {
      /**
    An HTMLBars AST transformation that replaces all instances of
  ...
  */
    ...
    @param {AST} ast The AST to be transformed.
  */
      TransformWithAsToHash.prototype.transform = function TransformWithAsToHash_transform(
        ast
      ) {
        var pluginContext = this;
        var walker = new pluginContext.syntax.Walker();
        ...
        walker.visit(ast, function (node) {
          if (pluginContext.validate(node)) {
            if (node.program && node.program.blockParams.length) {
              throw new Error(
                "You cannot use keyword (`{{with foo as bar}}`) and block params (`{{with foo as |bar|}}`) at the same time."
              );
            }
            ...
            Ember.deprecate(
              "Using {{with}} without block syntax " +
                moduleInfo +
                "is deprecated. " +
              ...
              {
                url:
                  "http://emberjs.com/deprecations/v1.x/#toc_code-as-code-sytnax-for-code-with-code",
              }
            );
      ...
      TransformWithAsToHash.prototype.validate = function TransformWithAsToHash_validate(
        node
      ) {
        return (
          node.type === "BlockStatement" &&
...
*/
  ...
  */
      ...
      exports["default"] = function (templateString, options) {
        ...
        var templateSpec = compile(
          templateString,
          (0, _emberTemplateCompilerSystemCompile_options["default"])(options)
        );

        return (0, _emberTemplateCompilerSystemTemplate["default"])(
          templateSpec
        );
      };
    }
...
*/
  ...
  */
      ...
      exports["default"] = function (templateString, options) {
        ...
        if (!compileSpec) {
          throw new Error(
            "Cannot call `compileSpec` without the template compiler loaded. Please load `ember-template-compiler.js` prior to calling `compileSpec`."
          );
        }
...
*/
  ...
  */
  ...
  enifed(
    "ember-template-compiler/system/template",
    ["exports", "htmlbars-runtime/hooks"],
  ...
  */
  ...
  enifed(
    "htmlbars-compiler",
    ["exports", "./htmlbars-compiler/compiler"],
    function (exports, _htmlbarsCompilerCompiler) {
  ...
  enifed(
    "htmlbars-compiler/compiler",
    [
      "exports",
      "../htmlbars-syntax/parser",
      "./template-compiler",
    ...
    function (
      ...
      function compile(string, options) {
        return (0, _htmlbarsRuntimeHooks.wrap)(
          template(compileSpec(string, options)),
          _htmlbarsRuntimeRender["default"]
        );
      }
    }
  );
  /*jshint evil:true*/
  enifed(
    "htmlbars-compiler/fragment-javascript-compiler",
    ["exports", "./utils", "../htmlbars-util/quoting"],
    function (exports, _utils, _htmlbarsUtilQuoting) {
      ...
      FragmentJavaScriptCompiler.prototype.compile = function (
        opcodes,
        options
      ) {
      ...
      FragmentJavaScriptCompiler.prototype.createFragment = function () {
        ...
        this.source.push(
          this.indent + "  var " + el + " = dom.createDocumentFragment();\n"
        );
      };
      ...
      FragmentJavaScriptCompiler.prototype.createElement = function (tagName) {
        ...
        this.source.push(
          this.indent +
            ...
            el +
            " = dom.createElement(" +
            (0, _htmlbarsUtilQuoting.string)(tagName) +
            ");\n"
        );
      ...
      FragmentJavaScriptCompiler.prototype.createText = function (str) {
        ...
        this.source.push(
          this.indent +
            ...
            el +
            " = dom.createTextNode(" +
            (0, _htmlbarsUtilQuoting.string)(str) +
            ");\n"
        );
      };
      ...
      FragmentJavaScriptCompiler.prototype.setAttribute = function (
        name,
        value,
        namespace
      ) {
        ...
        if (namespace) {
          this.source.push(
            this.indent +
              ...
              el +
              "," +
              (0, _htmlbarsUtilQuoting.string)(namespace) +
              "," +
              (0, _htmlbarsUtilQuoting.string)(name) +
              "," +
              (0, _htmlbarsUtilQuoting.string)(value) +
              ");\n"
          );
        } else {
          this.source.push(
      ...
      FragmentJavaScriptCompiler.prototype.appendChild = function () {
        ...
        var el = "el" + this.depth;
        this.source.push(
          this.indent + "  dom.appendChild(" + el + ", " + child + ");\n"
        );
      };
      ...
      FragmentJavaScriptCompiler.prototype.pushNamespaceFrame = function (
        frame
      ) {
        ...
        if (this.domNamespace !== correctNamespace) {
          this.source.push(
            this.indent +
              "  dom.setNamespace(" +
              (correctNamespace
                ? (0, _htmlbarsUtilQuoting.string)(correctNamespace)
                : "null") +
              ");\n"
          );
  ...
  enifed(
    "htmlbars-compiler/fragment-opcode-compiler",
    [
      "exports",
      "./template-visitor",
      "./utils",
      "../htmlbars-util",
      "../htmlbars-util/array-utils",
    ],
    function (
      exports,
      _templateVisitor,
      ...
      FragmentOpcodeCompiler.prototype.openElement = function (element) {
        ...
        (0, _htmlbarsUtilArrayUtils.forEach)(
          element.attributes,
          this.attribute,
          this
        );
  ...
  enifed(
    "htmlbars-compiler/hydration-javascript-compiler",
    ["exports", "./utils", "../htmlbars-util/quoting"],
    function (exports, _utils, _htmlbarsUtilQuoting) {
      ...
      prototype.compile = function (opcodes, options) {
        ...
        if (this.hasOpenBoundary) {
          this.source.unshift(
            this.indent + "  dom.insertBoundary(fragment, 0);\n"
          );
        }

        if (this.hasCloseBoundary) {
          this.source.unshift(
            this.indent + "  dom.insertBoundary(fragment, null);\n"
          );
        }
        ...
        if (this.fragmentProcessing.length) {
          ...
          for (i = 0, l = this.fragmentProcessing.length; i < l; ++i) {
            processing +=
              this.indent + "  " + this.fragmentProcessing[i] + "\n";
          }
      ...
      prototype.createMorph = function (
        morphNum,
        parentPath,
        startIndex,
        endIndex,
      ...
      prototype.createAttrMorph = function (
        attrMorphNum,
        elementNum,
        name,
        escaped,
      ...
      prototype.repairClonedNode = function (
        blankChildTextNodes,
        isElementChecked
      ) {
        var parent = this.getParent(),
          processing =
            "if (this.cachedFragment) { dom.repairClonedNode(" +
            parent +
            "," +
            (0, _htmlbarsUtilQuoting.array)(blankChildTextNodes) +
      ...
      prototype.shareElement = function (elementNum) {
        ...
        this.fragmentProcessing.push(
          "var " + elementNodesName + " = " + this.getParent() + ";"
        );
  ...
  enifed(
    "htmlbars-compiler/hydration-opcode-compiler",
    [
      "exports",
      "./template-visitor",
      "./utils",
    ...
    function (
      ...
      HydrationOpcodeCompiler.prototype.openElement = function (
        element,
        pos,
        len,
        mustacheCount,
      ...
      HydrationOpcodeCompiler.prototype.mustache = function (
        mustache,
        childIndex,
        childCount
      ) {
      ...
      HydrationOpcodeCompiler.prototype.block = function (
        block,
        childIndex,
        childCount
      ) {
      ...
      HydrationOpcodeCompiler.prototype.component = function (
        component,
        childIndex,
        childCount
      ) {
      ...
      HydrationOpcodeCompiler.prototype.MustacheStatement = function (
        mustache
      ) {
        prepareHash(this, mustache.hash);
        prepareParams(this, mustache.params);
  ...
  enifed(
    "htmlbars-compiler/template-compiler",
    [
      "exports",
      "./fragment-opcode-compiler",
      "./fragment-javascript-compiler",
      "./hydration-opcode-compiler",
      "./hydration-javascript-compiler",
      "./template-visitor",
      "./utils",
      "../htmlbars-util/quoting",
      "../htmlbars-util/array-utils",
    ],
    function (
      exports,
      _fragmentOpcodeCompiler,
      _fragmentJavascriptCompiler,
      _hydrationOpcodeCompiler,
      _hydrationJavascriptCompiler,
      _templateVisitor,
      _utils,
      _htmlbarsUtilQuoting,
      _htmlbarsUtilArrayUtils
    ) {
      ...
      TemplateCompiler.prototype.startProgram = function (
        program,
        childTemplateCount,
        blankChildTextNodes
      ) {
        this.fragmentOpcodeCompiler.startProgram(
          program,
          childTemplateCount,
          blankChildTextNodes
        );
        this.hydrationOpcodeCompiler.startProgram(
          program,
          childTemplateCount,
          blankChildTextNodes
        );
      ...
      TemplateCompiler.prototype.getChildTemplateVars = function (indent) {
        ...
        if (this.childTemplates) {
          for (var i = 0; i < this.childTemplates.length; i++) {
            vars +=
              indent + "var child" + i + " = " + this.childTemplates[i] + ";\n";
          }
        }
        return vars;
      };
      ...
      TemplateCompiler.prototype.getHydrationHooks = function (indent, hooks) {
        ...
        if (hookVars.length > 0) {
          return (
            indent + "var hooks = env.hooks, " + hookVars.join(", ") + ";\n"
          );
        } else {
          return "";
        }
      ...
      TemplateCompiler.prototype.endProgram = function (program, programDepth) {
        ...
        var statements = (0, _htmlbarsUtilArrayUtils.map)(
          hydrationPrograms.statements,
          function (s) {
        ...
        var templates = (0, _htmlbarsUtilArrayUtils.map)(
          this.childTemplates,
          function (_, index) {
            return "child" + index;
          }
      ...
      TemplateCompiler.prototype.openElement = function (
        element,
        i,
        l,
        r,
  ...
  enifed("htmlbars-compiler/template-visitor", ["exports"], function (exports) {
    ...
    TemplateVisitor.prototype.Program = function (program) {
      ...
      programFrame.actions.push([
        ...
        [
          program,
          programFrame.childTemplateCount,
    ...
    TemplateVisitor.prototype.ElementNode = function (element) {
      ...
      elementFrame.actions.push([
        "openElement",
        actionArgs.concat([
          elementFrame.mustacheCount,
          elementFrame.blankChildTextNodes.reverse(),
        ]),
      ]);
      this.popFrame();
    ...
    TemplateVisitor.prototype.ComponentNode = function (node) {
      ...
      frame.actions.push([
        "component",
        [node, frame.childIndex, frame.childCount],
      ]);
    ...
    TemplateVisitor.prototype.CommentStatement = function (text) {
      ...
      frame.actions.push([
        "comment",
        [text, frame.childIndex, frame.childCount],
      ]);
    };
  ...
  enifed(
    ...
    [
      ...
      "./htmlbars-runtime/hooks",
      "./htmlbars-runtime/render",
      "../htmlbars-util/morph-utils",
      "../htmlbars-util/template-utils",
      "./htmlbars-runtime/expression-visitor",
      "htmlbars-runtime/hooks",
    ],
    function (
      exports,
      ...
      var internal = {
        ...
        hostYieldWithShadowTemplate:
          _htmlbarsRuntimeHooks2.hostYieldWithShadowTemplate,
        visitChildren: _htmlbarsUtilMorphUtils.visitChildren,
        validateChildMorphs:
          _htmlbarsRuntimeExpressionVisitor.validateChildMorphs,
  ...
  enifed(
    ...
    [
      "exports",
      "../htmlbars-util/object-utils",
      "../htmlbars-util/morph-utils",
    ],
    function (exports, _htmlbarsUtilObjectUtils, _htmlbarsUtilMorphUtils) {
      /**
    Node classification:
  ...
  */
      ...
      var base = {
        acceptExpression: function (node, env, scope) {
          ...
          switch (node[0]) {
            ...
            case "value":
              ...
              break;
            case "get":
              ret.value = this.get(node, env, scope);
              break;
            case "subexpr":
              ret.value = this.subexpr(node, env, scope);
              break;
            case "concat":
              ret.value = this.concat(node, env, scope);
              break;
          }
        ...
        acceptHash: function (pairs, env, scope) {
          ...
          for (var i = 0, l = pairs.length; i < l; i += 2) {
            object[pairs[i]] = this.acceptExpression(
              pairs[i + 1],
              env,
              scope
            ).value;
        ...
        linkParamsAndHash: function (env, scope, morph, path, params, hash) {
          ...
          (0, _htmlbarsUtilMorphUtils.linkParams)(
            env,
            scope,
            morph,
            path,
      ...
      var AlwaysDirtyVisitor = (0, _htmlbarsUtilObjectUtils.merge)(
        (0, _htmlbarsUtilObjectUtils.createObject)(base),
        {
          ...
          block: function (node, morph, env, scope, template, visitor) {
            var path = node[1],
              ...
              templateId = node[4],
              inverseId = node[5];
            var paramsAndHash = this.linkParamsAndHash(
              env,
              scope,
              morph,
              path,
      ...
      exports["default"] = (0, _htmlbarsUtilObjectUtils.merge)(
        (0, _htmlbarsUtilObjectUtils.createObject)(base),
        {
          // [ 'block', path, params, hash, templateId, inverseId ]
          block: function (node, morph, env, scope, template, visitor) {
      ...
      function isHelper(env, scope, path) {
        return (
          env.hooks.keywords[path] !== undefined ||
          env.hooks.hasHelper(env, scope, path)
        );
      }
    }
  );
  ...
  */
      ...
      function yieldTemplate(
        ...
        return function (blockArguments, self) {
          ...
          if (morph.morphList) {
            (0, _htmlbarsUtilTemplateUtils.clearMorphList)(
              morph.morphList,
              morph,
              env
            );
          ...
          if (
            morph.lastYielded &&
            isStableTemplate(template, morph.lastYielded)
          ) {
            return morph.lastResult.revalidateWith(
              env,
              undefined,
              self,
              blockArguments,
          ...
          (0, _render["default"])(template, env, scope, {
            renderNode: morph,
            self: self,
      ...
      function yieldItem(
        ...
        return function (key, blockArguments, self) {
          if (typeof key !== "string") {
            throw new Error(
              "You must provide a string key when calling `yieldItem`; you provided " +
                key
            );
          }
      ...
      function yieldInShadowTemplate(
        template,
        env,
        parentScope,
        morph,
        ...
        var hostYield = hostYieldWithShadowTemplate(
          template,
          env,
          parentScope,
          morph,
      ...
      function hostYieldWithShadowTemplate(
        template,
        env,
        parentScope,
        morph,
        ...
        return function (shadowTemplate, env, self, blockArguments) {
          ...
          if (
            morph.lastYielded &&
            isStableShadowRoot(template, shadowTemplate, morph.lastYielded)
          ) {
            return morph.lastResult.revalidateWith(
              env,
              undefined,
          ...
          env.hooks.bindShadowScope(
            env,
            parentScope,
            shadowScope,
            renderState.shadowOptions
          );
          ...
          (0, _render["default"])(shadowTemplate.raw, env, shadowScope, {
            renderNode: morph,
            self: self,
            blockArguments: blockArguments,
          });
        ...
        function blockToYield(
          ...
          if (renderNode.lastResult) {
            renderNode.lastResult.revalidateWith(
              env,
              undefined,
              undefined,
              blockArguments,
      ...
      function isStableShadowRoot(template, shadowTemplate, lastYielded) {
        return (
          template === lastYielded.template &&
          shadowTemplate === lastYielded.shadowTemplate
        );
      }
      ...
      function optionsFor(template, inverse, env, scope, morph, visitor) {
        ...
        var renderState = new _htmlbarsUtilTemplateUtils.RenderState(
          morphToClear,
  ...
  */
      ...
      function createChildScope(parent) {
        ...
        scope.locals = (0, _htmlbarsUtilObjectUtils.createObject)(
          parent.locals
        );
        return scope;
      }
  ...
  */
      ...
      function hostBlock(
        ...
        (0, _htmlbarsUtilTemplateUtils.renderAndCleanup)(
          morph,
          env,
          options,
          shadowOptions,
          ...
          switch (redirect) {
            case "component":
              env.hooks.component(
                ...
                params,
                hash,
                { default: template, inverse: inverse },
                visitor
              );
              break;
            case "inline":
              env.hooks.inline(morph, env, scope, path, params, hash, visitor);
              break;
            case "block":
              env.hooks.block(
                morph,
            ...
            default:
              throw new Error(
                "Internal HTMLBars redirection to " +
                  redirect +
                  " not supported"
              );
          }
      ...
      function handleKeyword(
        ...
        if (keyword.setupState) {
          ...
          newState = morph.state = keyword.setupState(
            lastState,
            env,
            scope,
            params,
      ...
      function stableState(oldState, newState) {
        if (
          (0, _htmlbarsUtilObjectUtils.keyLength)(oldState) !==
          (0, _htmlbarsUtilObjectUtils.keyLength)(newState)
        ) {
          return false;
        }
  ...
  */
      ...
      function inline(morph, env, scope, path, params, hash, visitor) {
        ...
        if (morph.linkedResult) {
          ...
          var helper = env.hooks.lookupHelper(env, scope, path);
          var result = env.hooks.invokeHelper(
            morph,
            env,
            scope,
            visitor,
  ...
  */
      ...
      function element(morph, env, scope, path, params, hash, visitor) {
        ...
        var helper = env.hooks.lookupHelper(env, scope, path);
        if (helper) {
          env.hooks.invokeHelper(null, env, scope, null, params, hash, helper, {
  ...
  */
      ...
      function componentFallback(morph, env, scope, tagName, attrs, template) {
        ...
        var fragment = (0, _render["default"])(template, env, scope, {})
          .fragment;
  ...
  ); /* env, scope, path */ /* env, scope */
  /* morph, env, scope, params, hash */ // this function is used to handle host-specified extensions to scope
  // other than `self`, `locals` and `block`.
  enifed(
    "htmlbars-runtime/morph",
    ["exports", "../morph-range", "../htmlbars-util/object-utils"],
    function (exports, _morphRange, _htmlbarsUtilObjectUtils) {
      var guid = 1;
      ...
      var prototype = (HTMLBarsMorph.prototype = (0,
      _htmlbarsUtilObjectUtils.createObject)(_morphRange["default"].prototype));
  ...
  enifed(
    ...
    function (
      ...
      function render(template, env, scope, options) {
        ...
        var renderResult = RenderResult.build(
          env,
          scope,
          template,
          options,
      ...
      function RenderResult(
        ...
        if (options.attributes !== undefined) {
          ...
          this.statements.push([
            "attributes",
            attachAttributes(options.attributes),
          ]);
        }
      ...
      RenderResult.build = function (
        ...
        if (rootNode.childNodes) {
          (0, _htmlbarsUtilMorphUtils.visitChildren)(
            rootNode.childNodes,
            function (node) {
      ...
      RenderResult.prototype.revalidate = function (
        env,
        self,
        blockArguments,
        scope
      ...
      RenderResult.prototype.rerender = function (
        ...
        this.revalidateWith(
          ...
          self,
          blockArguments,
          _expressionVisitor.AlwaysDirtyVisitor
        );
      };

      RenderResult.prototype.revalidateWith = function (
        env,
        scope,
        self,
        blockArguments,
      ...
      RenderResult.prototype.populateNodes = function (visitor) {
        ...
        for (i = 0, l = statements.length; i < l; i++) {
          ...
          switch (statement[0]) {
            case "block":
              visitor.block(statement, morph, env, scope, template, visitor);
              break;
            case "inline":
              visitor.inline(statement, morph, env, scope, visitor);
              break;
            case "content":
              visitor.content(statement, morph, env, scope, visitor);
              break;
            case "element":
              visitor.element(statement, morph, env, scope, template, visitor);
              break;
            case "attribute":
              visitor.attribute(statement, morph, env, scope);
              break;
            case "component":
              visitor.component(
                statement,
      ...
      function createChildMorph(dom, parentMorph, contextualElement) {
        var morph = _morph["default"].empty(
          dom,
          contextualElement || parentMorph.contextualElement
        );
  ...
  enifed(
    ...
    [
      "exports",
      "./htmlbars-syntax/walker",
      "./htmlbars-syntax/builders",
      "./htmlbars-syntax/parser",
    ],
    function (
      exports,
      _htmlbarsSyntaxWalker,
  ...
  enifed(
    "htmlbars-syntax/handlebars/compiler/ast",
    ["exports"],
    function (exports) {
      var AST = {
  ...
  enifed(
    "htmlbars-syntax/handlebars/compiler/base",
    [
      "exports",
      "./parser",
      "./ast",
    ...
    function (exports, _parser, _ast, _whitespaceControl, _helpers, _utils) {
      exports.parse = parse;
  ...
  enifed(
    "htmlbars-syntax/handlebars/compiler/helpers",
    ["exports", "../exception"],
    function (exports, _exception) {
  ...
  enifed(
    "htmlbars-syntax/handlebars/compiler/parser",
    ["exports"],
    function (exports) {
      ...
      var handlebars = (function () {
        var parser = {
          ...
          table: [
            ...
            { 31: [2, 56], 69: [2, 56] },
            { 31: [2, 63], 35: 109, 68: 110, 69: [1, 108] },
            {
              31: [2, 60],
              59: [2, 60],
              66: [2, 60],
  ...
  enifed(
    "htmlbars-syntax/handlebars/compiler/visitor",
    ["exports", "../exception", "./ast"],
    function (exports, _exception, _ast) {
      function Visitor() {
        this.parents = [];
      }
  ...
  ); /* comment */ /* path */ /* string */ /* number */ /* bool */ /* literal */ /* literal */
  /* content */ enifed(
    "htmlbars-syntax/handlebars/compiler/whitespace-control",
    ["exports", "./visitor"],
    function (exports, _visitor) {
  ...
  enifed(
    "htmlbars-syntax/handlebars/exception",
    ["exports"],
    function (exports) {
      var errorProps = [
        "description",
  ...
  enifed(
    "htmlbars-syntax/handlebars/safe-string",
    ["exports"],
    function (exports) {
  ...
  enifed(
    "htmlbars-syntax/node-handlers",
    ["exports", "./builders", "../htmlbars-util/array-utils", "./utils"],
    function (exports, _builders, _htmlbarsUtilArrayUtils, _utils) {
      var nodeHandlers = {
        Program: function (program) {
          var body = [];
          var node = (0, _builders.buildProgram)(
            body,
            program.blockParams,
            program.loc
          );
        ...
        BlockStatement: function (block) {
          ...
          var node = (0, _builders.buildBlock)(
            block.path,
            block.params,
            block.hash,
            program,
        ...
        MustacheStatement: function (rawMustache) {
          ...
          var mustache = _builders["default"].mustache(
            path,
            params,
            hash,
            !escaped,
          ...
          if (this.tokenizer.state === "comment") {
            this.tokenizer.addChar(
              "{{" + this.sourceForMustache(mustache) + "}}"
            );
            return;
          }
        ...
        ContentStatement: function (content) {
          ...
          if (content.rightStripped) {
            changeLines = leadingNewlineDifference(
              content.original,
              content.value
            );
          }
          ...
          return (0, _htmlbarsUtilArrayUtils.forEach)(
            tokens,
            this.acceptToken,
            this
          );
  ...
  enifed(
    ...
    [
      ...
      "./tokenizer",
      "../simple-html-tokenizer/entity-parser",
      "../simple-html-tokenizer/char-refs/full",
      "./node-handlers",
      "./token-handlers",
      "../htmlbars-syntax",
    ],
    function (
      ...
      _tokenizer,
      _simpleHtmlTokenizerEntityParser,
      _simpleHtmlTokenizerCharRefsFull,
      _nodeHandlers,
      _tokenHandlers,
      _htmlbarsSyntax
    ) {
      ...
      function preprocess(html, options) {
        var ast =
          typeof html === "object"
            ? html
            : (0, _handlebarsCompilerBase.parse)(html);
      ...
      function HTMLProcessor(source, options) {
        this.options = options || {};
        this.elementStack = [];
        this.tokenizer = new _tokenizer.Tokenizer(
          new _simpleHtmlTokenizerEntityParser["default"](
            _simpleHtmlTokenizerCharRefsFull["default"]
          )
        );
  ...
  enifed(
    "htmlbars-syntax/token-handlers",
    ["exports", "./builders", "./utils", "../htmlbars-util/void-tag-names"],
    function (exports, _builders, _utils, _htmlbarsUtilVoidTagNames) {
      ...
      var tokenHandlers = {
        ...
        StartTag: function (tag) {
          var element = (0, _builders.buildElement)(
            tag.tagName,
            tag.attributes,
            tag.modifiers || [],
            []
          ...
          if (
            _htmlbarsUtilVoidTagNames["default"].hasOwnProperty(tag.tagName) ||
            tag.selfClosing
          ) {
        ...
        EndTag: function (tag, selfClosing) {
          ...
          var disableComponentGeneration =
            this.options.disableComponentGeneration === true;
          ...
          if (disableComponentGeneration || element.tag.indexOf("-") === -1) {
            ...
            var component = (0, _builders.buildComponent)(
              element.tag,
              element.attributes,
              program,
              element.loc
      ...
      function validateEndTag(tag, element, selfClosing) {
        ...
        if (_htmlbarsUtilVoidTagNames["default"][tag.tagName] && !selfClosing) {
          ...
          error =
            "Closing tag " + formatEndTagInfo(tag) + " without an open tag.";
  ...
  enifed(
    ...
    function (
      exports,
      _simpleHtmlTokenizer,
      _utils,
      _htmlbarsUtilArrayUtils,
      _builders
    ) {
      _simpleHtmlTokenizer.Tokenizer.prototype.createAttribute = function (
        char
      ) {
        if (this.token.type === "EndTag") {
          throw new Error(
            "Invalid end tag: closing tag must not have attributes, in " +
              formatTokenInfo(this) +
              "."
          );
        }
        this.currentAttribute = _builders["default"].attr(
          char.toLowerCase(),
          [],
          null
        );
      ...
      _simpleHtmlTokenizer.Tokenizer.prototype.markAttributeQuoted = function (
        value
      ) {
        this.currentAttribute.quoted = value;
      };

      _simpleHtmlTokenizer.Tokenizer.prototype.addToAttributeName = function (
        char
      ) {
        this.currentAttribute.name += char;
      };

      _simpleHtmlTokenizer.Tokenizer.prototype.addToAttributeValue = function (
        char
      ) {
        ...
        if (!this.currentAttribute.quoted && char === "/") {
          throw new Error(
            "A space is required between an unquoted attribute value and `/`, in " +
              formatTokenInfo(this) +
              "."
          );
        }
        if (
          !this.currentAttribute.quoted &&
          value.length > 0 &&
          (char.type === "MustacheStatement" ||
            value[0].type === "MustacheStatement")
        ) {
          throw new Error(
            "Unquoted attribute value must be a single string or mustache (on line " +
              this.line +
              ")"
          );
        }
        ...
        if (typeof char === "object") {
          if (char.type === "MustacheStatement") {
            ...
            throw new Error(
              "Unsupported node in attribute value: " + char.type
            );
          }
        } else {
      ...
      _simpleHtmlTokenizer.Tokenizer.prototype.finalizeAttributeValue = function () {
        if (this.currentAttribute) {
          this.currentAttribute.value = prepareAttributeValue(
      ...
      _simpleHtmlTokenizer.Tokenizer.prototype.addElementModifier = function (
        mustache
      ) {
        ...
        var modifier = _builders["default"].elementModifier(
          path,
          params,
          hash,
          loc
      ...
      function prepareAttributeValue(attr) {
        ...
        if (length === 0) {
          ...
          return _builders["default"].concat(
            (0, _htmlbarsUtilArrayUtils.map)(parts, prepareConcatPart)
          );
        }
      }
      ...
      function prepareConcatPart(node) {
        switch (node.type) {
          ...
          default:
            throw new Error(
              "Unsupported node in quoted attribute value: " + node.type
            );
        }
      }
      ...
      function formatTokenInfo(tokenizer) {
        return (
          "`" + tokenizer.token.tagName + "` (on line " + tokenizer.line + ")"
        );
      }
  ...
  enifed(
    "htmlbars-syntax/utils",
    ["exports", "../htmlbars-util/array-utils"],
    function (exports, _htmlbarsUtilArrayUtils) {
      ...
      function parseComponentBlockParams(element, program) {
        ...
        var asIndex = (0, _htmlbarsUtilArrayUtils.indexOfArray)(
          attrNames,
          "as"
        );
  ...
  enifed(
    ...
    ["exports", "../simple-html-tokenizer", "../htmlbars-util/array-utils"],
    function (exports, _simpleHtmlTokenizer, _htmlbarsUtilArrayUtils) {
      ...
      function generateTokens(fragmentOrHtml) {
        ...
        return {
          tokens: (0, _simpleHtmlTokenizer.tokenize)(div.innerHTML),
          html: div.innerHTML,
        };
      }
      ...
      var ie8InnerHTML =
        ie8InnerHTMLTestElement.outerHTML.indexOf("id=womp") > -1;
      ...
      var textProperty =
        document.createElement("div").textContent === undefined
          ? "innerText"
          : "textContent";
  ...
  enifed(
    "htmlbars-util/handlebars/safe-string",
    ["exports"],
    function (exports) {
      // Build out our basic SafeString type
      function SafeString(string) {
  ...
  enifed("htmlbars-util/morph-utils", ["exports"], function (exports) {
    ...
    function validateChildMorphs(env, morph, visitor) {
      ...
      if (morph.morphList) {
        ...
        morph.lastResult.revalidateWith(
          env,
          undefined,
          undefined,
          undefined,
  ...
  enifed(
    "htmlbars-util/safe-string",
    ["exports", "./handlebars/safe-string"],
    function (exports, _handlebarsSafeString) {
      exports["default"] = _handlebarsSafeString["default"];
    }
  );
  enifed(
    "htmlbars-util/template-utils",
    ["exports", "../htmlbars-util/morph-utils"],
    function (exports, _htmlbarsUtilMorphUtils) {
      ...
      function blockFor(render, template, blockOptions) {
        var block = function (
          ...
          if (renderNode.lastResult) {
            ...
            var shadowScope = scope
              ? env.hooks.createChildScope(scope)
              : env.hooks.createFreshScope();
            ...
            renderAndCleanup(renderNode, env, options, null, function () {
              ...
              render(template, env, shadowScope, {
                renderNode: renderNode,
                blockArguments: blockArguments,
                attributes: attributes,
              });
  ...
  enifed(
    ...
    function (exports, _morphRangeUtils) {
      ...
      Morph.prototype.setText = function Morph$setText(text) {
        ...
        return this.setNode(
          text
            ? this.domHelper.createTextNode(text)
            : this.domHelper.createComment("")
        );
      };
      ...
      Morph.prototype.setRange = function (firstNode, lastNode) {
        ...
        if (previousFirstNode !== null) {
          ...
          if (parentNode !== null) {
            (0, _morphRangeUtils.insertBefore)(
              parentNode,
              firstNode,
              lastNode,
              previousFirstNode
            );
            (0, _morphRangeUtils.clear)(
              parentNode,
              previousFirstNode,
              this.lastNode
            );
      ...
      Morph.prototype.insertBeforeNode = function Morph$insertBeforeNode(
        parent,
        reference
      ) {
  ...
  enifed(
    ...
    function (exports, _utils) {
      ...
      prototype.insertBeforeMorph = function MorphList$insertBeforeMorph(
        morph,
        referenceMorph
      ) {
        ...
        if (referenceMorph && referenceMorph.parentMorphList !== this) {
          throw new Error(
            "The morph before which the new morph is to be inserted is not a child of this morph."
          );
        }
        ...
        if (mountedMorph) {
          ...
          var referenceNode = referenceMorph
            ? referenceMorph.firstNode
            : mountedMorph.lastNode.nextSibling;

          (0, _utils.insertBefore)(
            parentNode,
            morph.firstNode,
            morph.lastNode,
            referenceNode
          ...
          if (!this.firstChildMorph) {
            (0, _utils.clear)(
              this.mountedMorph.firstNode.parentNode,
        ...
        var previousMorph = referenceMorph
          ? referenceMorph.previousMorph
          : this.lastChildMorph;
        if (previousMorph) {
      ...
      prototype.removeChildMorph = function MorphList$removeChildMorph(morph) {
        if (morph.parentMorphList !== this) {
          throw new Error(
            "Cannot remove a morph from a parent it is not inside of"
          );
        }
  ...
  enifed(
    "morph-range/morph-list.umd",
    ["exports", "./morph-list"],
    function (exports, _morphList) {
  ...
  enifed(
    ...
    [
      "exports",
      "./simple-html-tokenizer/tokenizer",
      "./simple-html-tokenizer/tokenize",
      "./simple-html-tokenizer/generator",
      "./simple-html-tokenizer/generate",
      "./simple-html-tokenizer/tokens",
    ],
    function (
      exports,
      _simpleHtmlTokenizerTokenizer,
      _simpleHtmlTokenizerTokenize,
      _simpleHtmlTokenizerGenerator,
      _simpleHtmlTokenizerGenerate,
      _simpleHtmlTokenizerTokens
    ) {
  ...
  enifed(
    "simple-html-tokenizer/char-refs/min",
    ["exports"],
    function (exports) {
      exports["default"] = {
        quot: [34],
  ...
  enifed(
    "simple-html-tokenizer/tokenize",
    ["exports", "./tokenizer", "./entity-parser", "./char-refs/full"],
    function (exports, _tokenizer, _entityParser, _charRefsFull) {
      exports["default"] = tokenize;

      function tokenize(input) {
        var tokenizer = new _tokenizer["default"](
          new _entityParser["default"](_charRefsFull["default"])
        );
  ...
  enifed(
    "simple-html-tokenizer/tokenizer",
    ["exports", "./utils", "./tokens"],
    function (exports, _utils, _tokens) {
