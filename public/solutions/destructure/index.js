 ...
 * }
 */
function exercise1({ name, id: user_id, address: { country } }) {
  return {
    name,
    user_id,
    country,
 ...
 * }
 */
function exercise3({ id: artist_id, albums: [, secondAlbum, ...otherAlbums] }) {
  return {
    artist_id,
    secondAlbum,
    otherAlbums,
 ...
 */
function exercise4(
  { id: id1, cats: cats1, dogs: dogs1 },
  { id: id2, cats: cats2, dogs: dogs2 },
) {
  return {
    users: [id1, id2],
    cats: [...cats1, ...cats2],
